model_movement = function(StoreX, StoreY){                                          
############################################################ Prepare Data
 Trip = dim(StoreX)[2]  
...
array[MaxTicks, MaxTrip] real Distance;
array[MaxTicks, MaxTrip] real AngDiff;
}
...
'
 ...
 model_1 = cmdstanr::cmdstan_model(write_stan_file(model_code_1))
